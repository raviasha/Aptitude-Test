...
NAME = 'KSAT_Department_Installation_Guide_2026-09-10'
doc = Document()
sec = doc.sections[0]
...
p('KSAT 2.0.0  |  Integrity hardening test build  |  10 September 2026',True)
...
step(5,'Answer several questions, move forward and back, and confirm selections persist. Leave one unanswered to exercise the submission confirmation. Watch the time continue normally. Use the same PC for the whole attempt.')
...
('Full screen and saved answers','Pass / Fail','Pass / Fail'),
...
step(5,'Repeat sign-in, a disposable assessment, integrity checks, and upload/review checks before updating the remaining PCs. Record hashes per PC: a displayed version of 2.0.0 cannot distinguish these test builds. Do not leave a mixed client/server rollout in service.')
...
p('These hashes identify the published integrity-hardening test binaries dated 10 September 2026. Source revision: 4c41d30fb4659f8e893969a44a284a274f95f644. All filenames retain version 2.0.0. A later release needs its own checksum record and guide review.')
h('Files used for installation')
p('KSATCoordinatorSetup-2.0.0.exe  •  28,137,528 bytes',True)
code('b3cb79c861efabd1dca3518979c2381ba4925d2c5255382f9ce85a42123449e3')
p('KSATClientSetup-2.0.0.exe  •  28,045,496 bytes',True)
code('d3158701a382afc0fe5706288f28adee99588b7ca1d9bcc521b7a72f27410166')
h('Standalone executables for reference')
p('KSATCoordinator-2.0.0.exe  •  26,464,272 bytes',True)
code('3d09a076e4fa9b4fa0b890f9d8bf03bdf539b6fde6c253c188d0456bca3b4225')
p('KSATClient-2.0.0.exe  •  26,374,048 bytes',True)
code('37f4297a3a620d410e4dfabb2238d0a2819a3874b7519ec1728ba7eadb220cbe')
...
link('KSAT source and release files at this guide revision','https://github.com/raviasha/Aptitude-Test/tree/4c41d30fb4659f8e893969a44a284a274f95f644')
link('Project operations runbook','https://github.com/raviasha/Aptitude-Test/blob/4c41d30fb4659f8e893969a44a284a274f95f644/docs/distributed-assessment-operations.md')
