...
$guideDocx = Join-Path $guideDirectory 'KSAT_Department_Installation_Guide_2026-09-10_Timer_Fix.docx'
$guidePdf = Join-Path $guideDirectory 'KSAT_Department_Installation_Guide_2026-09-10_Timer_Fix.pdf'
$guideWord = $null
$guideDocument = $null
try {
