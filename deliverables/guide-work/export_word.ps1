...
$guideDocx = Join-Path $guideDirectory 'KSAT_Department_Installation_Guide_2026-09-10.docx'
$guidePdf = Join-Path $guideDirectory 'KSAT_Department_Installation_Guide_2026-09-10.pdf'
$guideWord = $null
$guideDocument = $null
try {
